...
# http_counts = url.apply(get_http).values
...
# https_counts = url.apply(get_https).values
...
# 2: feature_updated_dataset_X_2
X = hstack([csr_url_entropy, csr_domain_extension, csr_bs_count])
...
dfX.to_csv("minimal-features.csv", index=False)